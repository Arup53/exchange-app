    ...
    <div className="bg-white py-20">
      <div className="w-1/2 mx-auto rounded-2xl grid grid-cols-7 text-gray-400 gap-6 bg-[#f7f6f6] px-12 pt-12 pb-24 ">
        <div className="flex flex-col gap-6 mr-24 col-span-4">
          <h3 className="text-base">xCEX</h3>
          <p className="text-xs ">
            xCEX provides information and resources about the fundamentals of
            the decentralised non-custodial liquidity protocol called the Aave
            Protocol, comprised of open-source self-executing smart contracts
            that are deployed on various permissionless public blockchains, such
            as Ethereum (the "Aave Protocol" or the "Protocol"). Aave Labs does
            not control or operate any version of the Aave Protocol on any
            blockchain network.
          </p>
        </div>
